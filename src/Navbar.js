  ...
  const list = (anchor) => (
    ...
    >
      <div className="mycart_div">
        <h2 className="mycart">My Cart ({obj.mycart.length} items)</h2>
        <h2>
          <Button
            id="basic-button"
                ...
                <Box sx={{ width: "100%" }}>
                  <Collapse in={opencheckout}>
                    <Alert
                      ...
                      sx={{ mb: 2, color: "red",fontSize:"1.5vw",fontWeight:"bold" }}
                    >
                      Please Login First !
                    </Alert>
                  </Collapse>
  ...
  return (
    <>
        ...
        <div className="navbar_sub3">
          {["right"].map((anchor) => (
            <React.Fragment key={anchor}>
              {/* <Badge badgeContent={obj.mycart.length} color="primary" sx={style1}>
                <Button onClick={toggleDrawer(anchor, true)} variant="outlined" sx={{border:"1px solid green"}}>
                  <i class="fa-brands fa-opencart" id="cart_icon"></i>
                </Button>
              </Badge> */}
              <Button onClick={toggleDrawer(anchor, true)}>
                  <i class="fa-brands fa-opencart" id="cart_icon" style={{fontSize:"4vw"}}></i><span className="badge">{obj.mycart.length}</span>
                </Button>
              <Drawer
                anchor={anchor}
      ...
      <div className="navbar_2">
        ...
        <div>
          <select onClick={sortByPrice}>
            <option style={{fontSize:"1.5vw"}} disabled>Sort By Price :</option>
            <option value="low_high" style={{fontSize:"1.5vw"}}>Low to High</option>
            <option value="high_low" style={{fontSize:"1.5vw"}}>High to Low</option>
          </select>
        </div>
        <div>
          <input
        ...
        {obj.loggedin === false ? (
          <div className="login">
            <Tooltip title="Login / Signup">
              <IconButton
                sx={{ color: "#6a8a0a", paddingRight: "2vw" }}
            ...
            >
              ...
              <DialogContent>
                <DialogContentText>
                  ...
                  >
                    ...
                    />
                    <br />
                    <Button variant="contained" onClick={validateOtp} sx={{fontSize:"1.5vw"}}>
                      Login
                    </Button>
                    <div
                      className="otp_notmatched"
                      style={{ display: errorDisplay ,fontSize:"1.5vw"}}
                    >
              ...
              <DialogActions>
                <Button onClick={handleClose} autoFocus sx={{fontSize:"2vw"}}>
                  X Close
                </Button>
              </DialogActions>
            </Dialog>
