        ...
        <div className="product_sub1">
          ...
          <div className="categories_div">
            ...
            {/* <div className="cart_btn_div">
              <Badge badgeContent={obj.mycart.length} color="primary" sx={{fontSize:"1vw",padding:"0vw"}}>
              ...
              return (
                <>
                  <div>
                    ...
                    <p><img src={i.pimage} alt="product" id="product_img" /></p>
                    ...
                    <p>
                      ...
                      >
                        <ShoppingBagIcon id="ShoppingBagIcon"/> Add to
                        Basket
                      </Button>
                    </p>
                  </div></div>
